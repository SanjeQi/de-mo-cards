...
const PaymentCard = props => {
  let { background, backgroundPattern, issuerIcon, number, date, name } = props;
  ...
  return (
    <FlippingCard className="payment-card">
      <FlippingCardFront>
        ...
        />
        <IssuerIcon icon={issuerIcon} />
        <Chip />
        <PaymentCardNumber number={number} />
        <PaymentCardDate date={date} />
        <PaymentCardName name={name} />
      </FlippingCardFront>
      <FlippingCardBack>
        <div />
      </FlippingCardBack>
...
PaymentCard.propTypes = {
  ...
  issuerIcon: PropTypes.oneOfType([PropTypes.string, PropTypes.element])
    .isRequired,
